...
Route::get('get-brand-wish-products', [ProductController::class, 'brandWishProducts'])->name('brand.wish.products');
//Route::get("show-product/{category_id}/{sub_category_id}", "BicycleController@showProduct");
